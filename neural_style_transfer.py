...
def main(refer_img_path, target_img_path):
    ...
    # image 경로
    style_reference_image_path = 'static/img/ref/' + refer_img_path  # 스타일 참조 이미지
    target_image_path = 'static/img/' + target_img_path  # 타깃 이미지
    ...
    result_prefix = 'static/img/' + refer_img_name
    iterations = 1
